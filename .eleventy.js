...
module.exports = function(eleventyConfig) {
  ...
  eleventyConfig.setFreezeReservedData(false);
// Configure Nunjucks environment options
  eleventyConfig.setNunjucksEnvironmentOptions({
    throwOnUndefined: true, // Recommended for catching errors
    autoescape: false,     // Be careful with this, but needed if injecting raw HTML
  });
