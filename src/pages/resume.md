...
<section>
  ...
  <p>As the Lead Program Manager and Designer, I am responsible for creating product roadmaps, maintaining team goals in order to complete deliverables, and managing the internal software suite.</p>
  <ul>
...
<section>
  ...
  <div class="card">
    <div class="card-header text-h5">Massachusetts College of Liberal Arts <i>(North Adams, MA)</i></div>
    <div class="card-body">
      <p>
  ...
  <div class="card">
    <div class="card-body">
      <div class="row-badges">
        ...
        <span class="badge">Figma / FigJam</span>
        <span class="badge">Sketch</span>
        <span class="badge">Adobe XD</span>
        <span class="badge">HTML / CSS / SCSS</span>
        <span class="badge">Design Systems</span>
        <span class="badge">User Testing</span>
        <span class="badge">Agile / Scrum</span>
        <span class="badge">Roadmapping</span>
      </div>
    </div>
  </div>
</section>
<section>
  <h2 id="organizations">Organizations - Past &amp; Present</h2>
  <div class="row no-wrap mt-3">
    <div class="card">
      <div class="card-header text-h5">Professional Memberships</div>
      <div class="card-body">
        <p class="mb-1">
          <span class="text-bold">UXPA Boston</span> <date>2017 - Present</date>
        </p>
        <p class="mb-1">
          <span class="text-bold">W3C CSS Working Group</span> <date>April 2020 - August 2021</date>
        </p>
      </div>
    </div>
    <div class="card">
      <div class="card-header text-h5">Community Involvement</div>
      <div class="card-body">
        <p class="mb-1">
          <span class="text-bold">Brimfield Recreation Department</span> <date>June 2024 - Present</date>
          <br />
          <ul>
            <li>Treasurer, Board Member, Coach</li>
          </ul>
        </p>
        <p class="mb-1">
          <span class="text-bold">Brookfield Select Board</span> <date>May 2021 - October 2022</date>
        </p>
        <p class="mb-1">
          <span class="text-bold">Brookfield Planning Board</span> <date>May 2020 - March 2022</date>
        </p>
      </div>
    </div>
  </div>
