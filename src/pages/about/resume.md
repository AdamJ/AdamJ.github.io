...
<section class="pt-3 pb-3">
  ...
  <a href="{{ 'https://www.linkedin.com/in/ajjolicoeur' | url }}" class="btn btn-social" target="_blank" alt="Click to visit my LinkedIn profile"><i class="fa-brands fa-linkedin"></i> LinkedIn</a>
  <a href="{{ 'https://www.github.com/AdamJ' | url }}" class="btn btn-social" target="_blank" alt="Click to visit my GitHub profile"><i class="fa-brands fa-github"></i> GitHub</a>
</section>
