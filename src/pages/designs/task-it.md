...
<section class="responsive">
  ...
  <div class="grid">
      ...
      <div class="grid">
        <div class="s12 md6 l6">
          <article class="no-padding tertiary-container">
            <img class="responsive medium" src="../../img/task-it_user-flow.png" alt="Image of the user flow" loading="lazy">
          </article>
        ...
        <div class="s12 md6 l6">
          <article class="no-padding tertiary-container">
            <img class="responsive medium" src="../../img/task-it_user-states.png" alt="Image of the various user flow states" loading="lazy">
          </article>
          <div class="absolute bottom left right padding bottom-shadow white-text">
            <nav>
              <h5>User states</h5>
      ...
      <div class="grid">
        <div class="s12">
          <sl-image-comparer position="50">
            <img
              slot="after"
              src="../../img/task-it_task-details_wireframe.png" class="figure-img img-fluid rounded" alt="Image of the task details wireframe" loading="lazy" style="width:100%;">
            <img
              slot="before"
              src="../../img/task-it_task-details_mockup1.png" class="figure-img img-fluid rounded" alt="Image of the first version of the task details mockup" loading="lazy" style="width:100%;">
          </sl-image-comparer>
        </div>
      </div>
    </div>
    ...
    <div class="s12">
      ...
      <div class="s12 md6 l6">
        <article class="no-padding tertiary-container">
          <img class="responsive medium" src="../../img/task-it_user-survey.png" alt="Image of the user testing process" loading="lazy">
        </article>
        <div class="absolute bottom left right padding bottom-shadow white-text">
          <nav>
    ...
    <div class="s12">
      ...
      <div class="grid">
        <div class="s12 m4">
          <article class="no-padding tertiary-container">
            <img class="responsive medium" src="../../img/task-it_task-details_mockup2.png" alt="Image of the user testing process" loading="lazy">
          </article>
          <div class="absolute bottom left right padding bottom-shadow white-text">
            <nav>
              <h5>Version 2</h5>
        ...
        <div class="s12 m4">
          <article class="no-padding tertiary-container">
            <img class="responsive medium" src="../../img/task-it_task-details_mockup3.png" alt="Image of the user testing process" loading="lazy">
          </article>
          <div class="absolute bottom left right padding bottom-shadow white-text">
            <nav>
              <h5>Version 3</h5>
        ...
        <div class="s12 m4">
          <article class="no-padding tertiary-container">
            <img class="responsive medium" src="../../img/task-it_task-details_mockup4.png" alt="Image of the user testing process" loading="lazy">
          </article>
          <div class="absolute bottom left right padding bottom-shadow white-text">
            <nav>
              <h5>Version 4</h5>
