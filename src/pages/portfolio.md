...
<section>
  <div class="work-grid">
    <article class="card-image">
      <img src="{{ '/assets/img/task-it_product.webp' | url }}" alt="Task It project illustration" class="image-top" />
      <div class="card-body">
        <h3 class="two-line-header">Task Management System</h3>
    ...
    <article class="card-image">
      <img src="{{ '/assets/img/timetracker-loading-state.webp' | url }}" alt="Task It project illustration" class="image-top" />
        <div class="card-body">
          <h3 class="two-line-header">Weekly AI-Powered Work Summary</h3>
    ...
    <div class="work-grid">
      <article class="card-image">
        <img src="{{ '/assets/img/archparser_dashboard1.webp' | url }}" alt="Archparer dashboard image" class="image-top" />
          <h3 class="two-line-header">Archparser</h3>
        <div class="card-body">
          <p>Architectural drawing analysis platform for OCR-based architectural drawing management.</p>
          <div class="badges mb-2">
            <span class="badge">Development</span><span class="badge">Claude Code</span>
          </div>
          <a class="btn btn-primary" href="{{ '/development/archparser' | url }}">View Case Study</a>
        </div>
      </article>
      <article class="card-image">
        <img src="{{ '/assets/img/Storybook-GettingStarted.webp' | url }}" alt="Getting Started screen on Storybook" class="image-top" />
          <h3 class="two-line-header">Component Library</h3>
        <div class="card-body">
          ...
          <a class="btn btn-primary" href="{{ '/designs/component-library' | url }}">View Case Study</a>
        </div>
      </article>
    </div>
  </div>
