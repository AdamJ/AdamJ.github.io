...
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
  <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
    ...
    <div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="../img/CEA_Dashboard.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="Customer Engagement App Dashboard thumbnail" width="700" height="500" loading="lazy"></div>
  </div>
...
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
  <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
    ...
    <div class="bg-light shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="../img/Timetrak.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="Switchback Timetrak thumbnail" width="700" height="500" loading="lazy"></div>
  </div>
  <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
    <div class="my-3 p-3">
    ...
    <div class="bg-dark shadow-sm mx-auto" style="width: 80%; height: 300px; border-radius: 21px 21px 0 0;"><img src="../img/SC_demo.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="Structure Cloud UI screenshot" width="700" height="500" loading="lazy"></div>
  </div>
</div>
<div class="container col-xxl-8 px-4 pb-5">
  ...
  <div class="row flex-lg-row-reverse align-items-center gb-5 pb-5">
    ...
    <div class="col-10 col-sm-10 col-lg-6">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <a href="https://github.com/AdamJ/Bootstrap5-sketch/releases" class="btn btn-outline-primary px-4 me-md-2" target="_blank">Download from GitHub <i class="fas fa-file-download"></i></a>
      </div>
    </div>
  </div>
  ...
  <div class="row flex-lg-row-reverse align-items-center p-2">
    ...
    <div class="col-10 col-sm-10 col-lg-6">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <a href="https://atom.io/themes/atom-patternfly-ui" class="btn btn-outline-secondary px-4 me-md-2" target="_blank">View on Atom.io <i class="fas fa-link"></i></a>
      </div>
    </div>
  </div>
  <div class="row flex-lg-row-reverse align-items-center gb-5 pb-5">
    ...
    <div class="col-10 col-sm-10 col-lg-6">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <a href="https://atom.io/themes/atom-patternfly-syntax" class="btn btn-outline-secondary px-4 me-md-2" target="_blank">View on Atom.io <i class="fas fa-link"></i></a>
      </div>
    </div>
  </div>
</div>
