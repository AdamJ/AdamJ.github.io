...
<div class="container">
  <p class="lead text-center">
    In most cases, I will use something similar to my <a href="https://www.adamjolicoeur.com/DesignSprint/" target="top">Design Sprint</a> site to organize my research (competitive and inspirational), create an easy access point for design assets, and color palettes. If I'm working on a prototype, I'll often include that link as well.
  </p>
</div>
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
  <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
    <div class="my-3 py-3">
      ...
      <a href="/designs/customer-engagement" class="btn btn-light icon-link lead" alt="Click to experience the Customer Engagement journey">
        the journey
    ...
    <div class="mx-auto"><img src="../img/CEA_Dashboard.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="Customer Engagement App Dashboard thumbnail" width="700" height="500" loading="lazy"></div>
  </div>
  <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
    <div class="my-3 p-3">
      ...
      <a href="/designs/alm" class="btn btn-dark icon-link lead" alt="Click to experience the Application Lifecycle Management journey">
        the journey
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"fill="currentColor" class="bi bi-chevron-compact-right" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M6.776 1.553a.5.5 0 0 1 .671.223l3 6a.5.5 0 0 1 0 .448l-3 6a.5.5 0 1 1-.894-.448L9.44 8 6.553 2.224a.5.5 0 0 1 .223-.671z"/>
        </svg>
    ...
    <div class="bg-light mx-auto"><img src="../img/OSIO-laptop-screen-1200.png" class="d-block mx-lg-auto img-fluid" alt="Application Lifecycle Management thumbnail" width="700" height="500" loading="lazy"></div>
  </div>
</div>
<div class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
  <div class="bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
    <div class="my-3 py-3">
      <h2 class="display-5">Switchback TimeTrak</h2>
    ...
    <div class="mx-auto"><img src="../img/Timetrak.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="Switchback Timetrak thumbnail" width="700" height="500" loading="lazy"></div>
  </div>
  <div class="bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden">
    <div class="my-3 p-3">
      <h2 class="display-5">Structure</h2>
    ...
    <div class="mx-auto"><img src="../img/SC_demo.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="Structure Cloud UI screenshot" width="700" height="500" loading="lazy"></div>
  </div>
</div>
<div class="container col-xxl-8 px-4 pb-5">
  <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
    <div class="col-10 col-sm-10 col-lg-6">
      ...
      <!-- <a href="/history/district25" class="icon-link">
        History
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"fill="currentColor" class="bi bi-chevron-compact-right" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M6.776 1.553a.5.5 0 0 1 .671.223l3 6a.5.5 0 0 1 0 .448l-3 6a.5.5 0 1 1-.894-.448L9.44 8 6.553 2.224a.5.5 0 0 1 .223-.671z"/>
        </svg>
    ...
    <div class="col-lg-6">
      <img src="../img/District25Desktop.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="District 25 website" width="700" height="500" loading="lazy">
    </div>
  </div>
  <h2 class="display-5 fw-bold lh-1">Wireframes</h2>
  <div class="row flex-lg-row-reverse align-items-center gb-5 pb-5">
    <div class="col-lg-6">
      <img src="../img/Dashboardwireframe.png" alt="Structure Cloud logo" width="auto" height="200" loading="lazy">
      <img src="../img/RPLOnePage.png" alt="Structure Cloud logo w/text" width="auto" height="200" loading="lazy">
    </div>
    <div class="col-10 col-sm-10 col-lg-6">
  ...
  <div class="row flex-lg-row-reverse align-items-center gb-5 pb-5">
    ...
    <div class="col-lg-6">
      ...
      <br>
      <img src="../img/Scouters.png" alt="Scouters Lodge logo" width="auto" height="100" loading="lazy">
      <img src="../img/TLG2012.jpg" alt="Two logos to be used on a glass" width="auto" height="100" loading="lazy">
    </div>
  </div>
  <h2 class="display-5 fw-bold lh-1">Sketch libraries</h2>
  <div class="row flex-lg-row-reverse align-items-center gb-5 pb-5">
    <div class="col-lg-6">
      <img src="../img/Bootstrap5SocialImage.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="Social tag for the Bootstrap 5 Sketch library" width="700" height="500" loading="lazy">
    </div>
    <div class="col-10 col-sm-10 col-lg-6">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <a href="https://github.com/AdamJ/Bootstrap5-sketch/releases" class="btn btn-outline-primary px-4 me-md-2" target="_blank">Download library from GitHub <i class="fas fa-file-download"></i></a>
      </div>
    </div>
  </div>
  ...
  <div class="row flex-lg-row-reverse align-items-center p-2">
    <div class="col-lg-6">
      <img src="../img/atom-pf-theme.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="Atom.io PatternFly Syntax screenshot" width="700" height="500" loading="lazy">
    </div>
    <div class="col-10 col-sm-10 col-lg-6">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <a href="https://atom.io/themes/atom-patternfly-ui" class="btn btn-outline-secondary px-4 me-md-2" target="_blank">View UI theme on Atom.io <i class="fas fa-link"></i></a>
      </div>
    </div>
  </div>
  <div class="row flex-lg-row-reverse align-items-center gb-5 pb-5">
    <div class="col-lg-6">
      <img src="../img/atom-pf-syntax.png" class="d-block mx-lg-auto img-fluid img-thumbnail" alt="Atom.io PatternFly Syntax screenshot" width="700" height="500" loading="lazy">
    </div>
    <div class="col-10 col-sm-10 col-lg-6">
      ...
      <div class="d-grid gap-2 d-md-flex justify-content-md-start">
        <a href="https://atom.io/themes/atom-patternfly-syntax" class="btn btn-outline-secondary px-4 me-md-2" target="_blank">View syntax theme on Atom.io <i class="fas fa-link"></i></a>
      </div>
    </div>
  </div>
</div>
